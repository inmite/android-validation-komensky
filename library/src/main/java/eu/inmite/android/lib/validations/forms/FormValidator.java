...
package eu.inmite.android.lib.validations.forms;
...
import eu.inmite.android.lib.validations.forms.annotations.Condition;
...
import eu.inmite.android.lib.validations.forms.iface.IValidationCallback;
import eu.inmite.android.lib.validations.forms.iface.IValidator;
import eu.inmite.android.lib.validations.forms.validators.ValidatorFactory;
...
/**
 * <p>
 *      Validate forms. Use either {@link #validate(android.support.v4.app.Fragment, eu.inmite.android.lib.validations.forms.iface.IValidationCallback)} methods
 *      to validate all views at once or start live validation by calling {@link #startLiveValidation(android.support.v4.app.Fragment, eu.inmite.android.lib.validations.forms.iface.IValidationCallback)}.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 *     To validate multiple views at once by one validator, use {@link eu.inmite.android.lib.validations.forms.annotations.Joined} annotation. <br/>
 *     You can also add condition to view and the validation will proceed only of the given condition is met, see {@link Condition}.
 * </p>
 * <p>
 *      For all available validations see package {@link eu.inmite.android.lib.validations.forms.annotations}.
 *      To add custom validation you can use {@link eu.inmite.android.lib.validations.forms.annotations.Custom} annotation and provide own {@link IValidator}.
 * </p>
 *
...
public class FormValidator {
	 ...
	 * Otherwise you can use {@link eu.inmite.android.lib.validations.forms.annotations.Custom} annotation.
	 *
	 * @param validator validator class that is annotated with {@link eu.inmite.android.lib.validations.forms.annotations.ValidatorFor} annotation.
	...
	/**
	 * stop previously started live validation by {@link #startLiveValidation(Object, android.view.View, eu.inmite.android.lib.validations.forms.iface.IValidationCallback)}
